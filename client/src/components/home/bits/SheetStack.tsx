 ...
 */
export default function SheetStack({ children }: { children: ReactNode[] }) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`relative flex min-h-screen flex-col justify-center overflow-hidden bg-paper will-change-transform ${
          index > 0
